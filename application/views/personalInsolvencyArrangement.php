...
<div class = "review">
    ...
    <h1>Personal Insolvency Arrangement</h1>
         <h2>It seems as if the best course of action for you to take would be to seek a Personal Insolvency Arrangement.</h2>
    ...
    <li>If it is a case of not being sure of what officer you should see, please don't worry. Our appointments usually allow for quick reference and consultation with the other relevant officer within half an hour. </li>
      ...
      <form id="form1" name="form1" method="post" action="<?php echo "$base/User/RegisterUserNumberPIA"; ?>">
     <h2>In order to assist in the keeping of accurate records, please set up a User Name and Password. These need not be your own name and please keep note of both<br>user name and password as they will be vital if you need to change details of your appointment later. </h2>
